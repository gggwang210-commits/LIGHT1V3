...
def calculate_qs(
    *args,
    ...
    """Calculate QS using the documented 40/30/20/10 weighted score.

    Positional and ``form/rep/rest/pain_level`` calls preserve the older
    dashboard shape. Named current-MVP inputs use
    ``form_accuracy/discomfort_response/rpe/qc_score``.
    """
    if args:
        if len(args) != 4:
        ...
        # Current MVP form: form accuracy, discomfort stability, RPE fit, QC.
